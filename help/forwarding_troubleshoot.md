...
Also check that you have forwarded the port that is set in the mod (default: `25001`); and that you have set the protocol to `TCP`, if it asks for that. Every player should use the same port you have set to connect. 
